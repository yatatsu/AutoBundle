...
public final class AutoBundle {
    ...
    /**
     * {@link IAutoBundleBinder} implement class will be generated by apt.
     * So if {@link Arg} does not used, impl class may not exist.
     */
    static final String BINDER_CLASS_NAME = "com.yatatsu.autobundle.autoBundleBinder";

    /**
     * static instance will load at the first time static method called.
     */
    private static IAutoBundleBinder autoBundleBinder;
    ...
    public static void bind(Object target, Bundle args) {
        IAutoBundleBinder binder = findBinder();
        if (binder != null) {
    ...
    static IAutoBundleBinder findBinder() {
        if (autoBundleBinder == null) {
            try {
                Class<?> binderClass = Class.forName(BINDER_CLASS_NAME);
                autoBundleBinder = (IAutoBundleBinder) binderClass.newInstance();
            } catch (Exception e) {
